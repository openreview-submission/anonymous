...
from .utils import tanh_approx, sech2_approx, log_kernel_autotune
...
def angle_dt_fwd_kernel(
    ...
    # Strides for OUT (batch, seqlen, nheads, dim) — output strides passed as scalars
...
def angle_dt_bwd_kernel(
    ...
    # Strides for GRAD_ANGLE (batch, seqlen, nheads, dim) — output strides as scalars
